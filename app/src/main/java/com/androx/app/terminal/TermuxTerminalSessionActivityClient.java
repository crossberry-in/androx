...
import com.androx.shared.termux.terminal.io.BellHandler;
import com.androx.shared.logger.Logger;
import com.androx.terminal.TerminalColors;
import com.androx.terminal.TerminalSession;
import com.androx.terminal.TerminalSessionClient;
import com.androx.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.androx.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.androx/com.androx.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
